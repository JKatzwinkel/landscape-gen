...
public class RT711_shots {
	public static void main(String[] args){
		...
		Light light = new Light(size/2-512+rnd.nextInt(1024),250,size/2-512+rnd.nextInt(1024),20, new Color(20,19,12));
...
//		light.whiz(1000d, ground, 1800);
		...
		for (int i=0;i<20;i++){
			...
			light = new Light(size/2-512+rnd.nextInt(1024),250,size/2-512+rnd.nextInt(1024),12+rnd.nextDouble()*12, new Color(10+rnd.nextInt(30),10+rnd.nextInt(30),10+rnd.nextInt(20)));
	...
	static String filename(int i) {
		return "25/shot"+"0000".substring(0,4-(""+i).length())+i;
	}
}
